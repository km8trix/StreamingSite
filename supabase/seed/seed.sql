...
insert into public.episodes (id, show_id, number, title, is_subbed, is_dubbed, air_date, video_url) values
  ('show-001-ep-001', 'show-001', 1, 'Episode 1', TRUE, TRUE, '2025-12-16', NULL),
  ...
  ('show-002-ep-001', 'show-002', 1, 'Episode 1', TRUE, FALSE, '2026-03-29', NULL),
  ...
  ('show-003-ep-001', 'show-003', 1, 'Episode 1', TRUE, TRUE, '2025-11-25', NULL),
  ...
  ('show-004-ep-001', 'show-004', 1, 'Episode 1', TRUE, FALSE, '2026-05-31', NULL),
  ('show-005-ep-001', 'show-005', 1, 'Episode 1', TRUE, TRUE, '2025-12-29', NULL),
  ...
  ('show-006-ep-001', 'show-006', 1, 'Episode 1', TRUE, TRUE, '2026-04-10', NULL),
  ...
  ('show-007-ep-001', 'show-007', 1, 'Episode 1', TRUE, TRUE, '2025-12-10', NULL),
  ...
  ('show-008-ep-001', 'show-008', 1, 'Episode 1', TRUE, TRUE, '2026-06-04', NULL),
  ('show-009-ep-001', 'show-009', 1, 'Episode 1', TRUE, TRUE, '2026-02-09', NULL),
  ...
  ('show-010-ep-001', 'show-010', 1, 'Episode 1', TRUE, TRUE, '2025-12-05', NULL),
  ...
  ('show-011-ep-001', 'show-011', 1, 'Episode 1', TRUE, TRUE, '2025-11-28', NULL),
  ...
  ('show-012-ep-001', 'show-012', 1, 'Episode 1', TRUE, TRUE, '2026-02-22', NULL),
  ...
  ('show-013-ep-001', 'show-013', 1, 'Episode 1', TRUE, TRUE, '2025-12-03', NULL),
  ...
  ('show-014-ep-001', 'show-014', 1, 'Episode 1', TRUE, FALSE, '2026-05-30', NULL),
  ('show-015-ep-001', 'show-015', 1, 'Episode 1', TRUE, TRUE, '2026-03-07', NULL),
  ...
  ('show-016-ep-001', 'show-016', 1, 'Episode 1', TRUE, TRUE, '2026-02-26', NULL),
  ...
  ('show-017-ep-001', 'show-017', 1, 'Episode 1', TRUE, TRUE, '2026-02-26', NULL),
  ...
  ('show-018-ep-001', 'show-018', 1, 'Episode 1', TRUE, TRUE, '2026-03-14', NULL),
  ...
  ('show-019-ep-001', 'show-019', 1, 'Episode 1', TRUE, TRUE, '2025-12-30', NULL),
  ...
  ('show-020-ep-001', 'show-020', 1, 'Episode 1', TRUE, TRUE, '2025-12-09', NULL),
  ...
  ('show-021-ep-001', 'show-021', 1, 'Episode 1', TRUE, TRUE, '2026-05-28', NULL),
  ('show-022-ep-001', 'show-022', 1, 'Episode 1', TRUE, TRUE, '2025-12-16', NULL),
  ...
  ('show-023-ep-001', 'show-023', 1, 'Episode 1', TRUE, TRUE, '2025-12-24', NULL),
  ...
  ('show-024-ep-001', 'show-024', 1, 'Episode 1', TRUE, TRUE, '2026-01-06', NULL),
...
('show-025-ep-001', 'show-025', 1, 'Episode 1', TRUE, FALSE, '2026-04-06', NULL),
  ...
  ('show-026-ep-001', 'show-026', 1, 'Episode 1', TRUE, FALSE, '2026-04-01', NULL),
  ...
  ('show-027-ep-001', 'show-027', 1, 'Episode 1', TRUE, FALSE, '2026-04-03', NULL),
  ...
  ('show-028-ep-001', 'show-028', 1, 'Episode 1', TRUE, FALSE, '2026-04-04', NULL),
  ...
  ('show-029-ep-001', 'show-029', 1, 'Episode 1', TRUE, FALSE, '2026-04-12', NULL),
  ...
  ('show-030-ep-001', 'show-030', 1, 'Episode 1', TRUE, FALSE, '2026-04-02', NULL),
  ...
  ('show-031-ep-001', 'show-031', 1, 'Episode 1', TRUE, FALSE, '2026-04-03', NULL),
  ...
  ('show-032-ep-001', 'show-032', 1, 'Episode 1', TRUE, FALSE, '2026-04-07', NULL),
  ...
  ('show-033-ep-001', 'show-033', 1, 'Episode 1', TRUE, FALSE, '2026-04-08', NULL),
  ...
  ('show-034-ep-001', 'show-034', 1, 'Episode 1', TRUE, FALSE, '2026-04-09', NULL),
  ...
  ('show-035-ep-001', 'show-035', 1, 'Episode 1', TRUE, FALSE, '2026-04-04', NULL),
  ...
  ('show-036-ep-001', 'show-036', 1, 'Episode 1', TRUE, FALSE, '2026-04-06', NULL),
  ...
  ('show-037-ep-001', 'show-037', 1, 'Episode 1', TRUE, FALSE, '2026-04-01', NULL),
  ...
  ('show-038-ep-001', 'show-038', 1, 'Episode 1', TRUE, FALSE, '2026-04-04', NULL),
  ...
  ('show-039-ep-001', 'show-039', 1, 'Episode 1', TRUE, FALSE, '2026-04-04', NULL),
